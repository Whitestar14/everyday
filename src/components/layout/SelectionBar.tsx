        ...
        <AnimatePresence>
            {isSelectionMode && (
                <motion.div
                    ...
                    className="fixed left-1/2 bottom-6 transform -translate-x-1/2 z-50 max-w-md w-[92%] mx-auto bg-muted/20 backdrop-blur-sm border border-border rounded-full px-4 py-2 shadow-lg flex items-center justify-between gap-3"
                >
                    ...
                    This will permanently delete the selected tasks. This action cannot be undone.
                                ...
                                <div className="flex justify-end gap-2 mt-4">
                                    ...
                                    <DialogClose asChild>
                                        <Button variant="destructive" size="sm" onClick={() => { bulkDeleteSelectedTasks(); clearSelection(); }}>
                      Confirm
                                        </Button>
                                    </DialogClose>
                                </div>
