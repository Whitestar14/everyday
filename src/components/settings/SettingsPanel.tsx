...
import { Sun, Moon, Monitor, AlignLeft, AlignCenter, AlignRight } from "lucide-react"
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <SheetHeader className="pb-6">
          <SheetTitle className="text-left text-lg font-normal">settings</SheetTitle>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground/70 -mt-1">where feels most comfortable?</p>
          ...
          <div className="text-center pt-4 border-t border-muted-foreground/10">
            <p className="text-xs text-muted-foreground/60">changes are saved automatically</p>
          </div>
        </div>
      </SheetContent>
    </Sheet>
